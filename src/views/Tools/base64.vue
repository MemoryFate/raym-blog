...
.tool-detail{width:min(1180px,calc(100% - 40px));margin:48px auto 0}.back{color:var(--color-text-secondary);font-size:11px;text-decoration:none}.eyebrow{margin:0;color:var(--color-accent-primary);font-size:10px;letter-spacing:.14em}.tool-head{display:flex;align-items:flex-end;justify-content:space-between;gap:30px;margin:34px 0 28px}.tool-head h1{margin:14px 0;font-size:clamp(42px,5vw,54px);letter-spacing:-.04em}.tool-head p:last-child{max-width:760px;margin:0;color:var(--color-text-secondary);font-size:15px;line-height:1.75}.status{color:var(--color-accent-primary);font-size:10px}.mode-tabs{display:grid;grid-template-columns:1fr 1fr;width:min(520px,100%);gap:6px;margin-bottom:20px;padding:5px;border:1px solid var(--color-border-default);border-radius:14px;background:var(--color-bg-raised)}.mode-tabs button,.type-switch button{min-height:42px;border:0;border-radius:10px;color:var(--color-text-secondary);background:transparent;cursor:pointer}.mode-tabs button.active,.type-switch button.active{color:var(--color-accent-contrast);background:var(--color-action-primary);font-weight:600}.tool-layout{display:grid;grid-template-columns:minmax(0,1fr) 360px;gap:20px}.work-surface{padding:26px}.surface-head{position:relative;z-index:1}.surface-head h2{margin:8px 0 0;font-size:26px}.type-switch{position:relative;z-index:1;display:grid;grid-template-columns:1fr 1fr;gap:6px;margin-top:24px}.type-switch button{border:1px solid var(--color-border-default);background:var(--color-bg-control)}.field{position:relative;z-index:1;display:grid;gap:9px;margin-top:24px;color:var(--color-text-primary);font-size:12px}.actions{position:relative;z-index:1;display:flex;gap:12px;margin-top:22px}.drop-zone{position:relative;z-index:1;display:grid;grid-template-columns:auto 1fr;gap:18px;align-items:center;min-height:130px;margin-top:24px;padding:20px;border:1px dashed var(--color-border-default);border-radius:16px;background:var(--color-bg-raised)}.drop-zone>div{display:grid;gap:5px}.drop-zone strong{font-size:13px}.drop-zone span{color:var(--color-text-secondary);font-size:11px}.plain-actions{position:relative;z-index:1;display:flex;gap:10px;margin-top:14px}.plain-actions button,.download{min-height:42px;padding:0 14px;border:1px solid var(--color-border-default);border-radius:10px;color:var(--color-text-primary);background:var(--color-bg-control);cursor:pointer}.side-stack{display:grid;align-content:start;gap:20px}.preview-card,.note-card{padding:22px}.preview-card>*,.note-card>*{position:relative;z-index:1}.preview-box{display:grid;min-height:280px;margin-top:16px;place-items:center;overflow:hidden;border:1px dashed var(--color-border-default);border-radius:15px;background:var(--color-bg-raised)}.preview-box img,.preview-box video{max-width:100%;max-height:360px}.placeholder{display:grid;place-items:center;color:var(--color-text-secondary);text-align:center}.placeholder span{display:grid;width:58px;height:58px;place-items:center;border:1px solid var(--color-border-strong);border-radius:15px;color:var(--color-accent-primary);background:var(--color-bg-control);font-size:18px}.placeholder p{font-size:11px}.download{width:100%;margin-top:12px}.note-card h3{margin:12px 0;font-size:22px}.note-card p:last-child{margin:0;color:var(--color-text-secondary);font-size:13px;line-height:1.75}
:deep(.ant-input){color:var(--color-text-primary)!important;background:var(--color-bg-control)!important;border-color:var(--color-border-default)!important}:deep(.ant-input::placeholder){color:color-mix(in srgb,var(--color-text-secondary) 70%,transparent)}:deep(.ant-btn){border-color:var(--color-border-default);color:var(--color-text-primary);background:var(--color-bg-control)}:deep(.ant-btn-primary){color:var(--color-accent-contrast);background:var(--color-action-primary);border-color:var(--color-action-primary)}
