...
:deep(.ant-input),:deep(.ant-input-affix-wrapper),:deep(.ant-input-password){color:var(--color-text-primary)!important;background:var(--color-bg-control)!important;border-color:var(--color-border-default)!important}:deep(.ant-input::placeholder){color:color-mix(in srgb,var(--color-text-secondary) 70%,transparent)}:deep(.ant-input-affix-wrapper input){color:var(--color-text-primary)!important;background:transparent!important}
