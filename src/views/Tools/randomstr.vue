...
:deep(.ant-input),:deep(.ant-input-number){width:100%;color:var(--color-text-primary)!important;background:var(--color-bg-panel-strong)!important;border-color:var(--color-border-glow)!important}:deep(.ant-btn-primary){color:var(--color-accent-contrast);background:var(--color-action-primary);border-color:var(--color-action-primary)}
