    ...
    <div class="home-page">
        <section class="hero">
            ...
            <NeonGlass class="console" raised glow>
                ...
                <div class="chips">
                    <span class="active">Vue</span><span>JavaScript</span><span>AI</span>
                </div>
            </NeonGlass>
        </section>
        ...
        <section id="projects" class="block anchor">
            ...
            <div class="project-grid">
                <RouterLink v-for="(project, index) in projects" :key="project.title" :to="project.path"
                    class="project-link">
                    <NeonGlass class="card project-card" interactive>
                        <div class="project-top"><i>{{ project.icon }}</i><span class="mono">0{{ index + 1 }} /
                                02</span></div>
            ...
            <div class="lab-grid">
                <NeonGlass class="tool-panel">
                    <div class="panel-head">
                        <div>
                            <p class="eyebrow">工具架</p>
                            <h3>常用小工具</h3>
                        </div>
                        <span class="mono">›_</span>
                    </div>
                    <div class="tools">
                        <RouterLink v-for="tool in tools" :key="tool.name" :to="tool.path"
                            :class="{ active: previewTool.name === tool.name }" @mouseenter="previewTool = tool"
        ...
        <section class="themes">
            ...
            <div class="theme-grid">
                <NeonGlass v-for="item in themeItems" :key="item.key" as="button" class="theme-card"
                    :class="{ active: theme === item.key }" :selected="theme === item.key" interactive
...
.divider {
    height: 1px;
    margin-top: 20px;
    background: color-mix(in srgb, var(--color-border-glow) 62%, transparent);
}
...
.feature p:not(.eyebrow):not(.preview-type) {
    position: relative;
    z-index: 1;
    max-width: 560px;
    color: var(--color-text-secondary);
...
.preview-lines span:nth-child(3) {
    width: 52%;
    background: color-mix(in srgb, var(--color-accent-primary) 50%, transparent);
}
