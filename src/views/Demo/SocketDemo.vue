...
.lab-detail{width:min(1180px,calc(100% - 40px));margin:48px auto 0}.back{color:var(--color-text-secondary);font-size:11px;text-decoration:none}.eyebrow{margin:0;color:var(--color-accent-primary);font-size:10px;letter-spacing:.14em}.lab-head{display:flex;align-items:flex-end;justify-content:space-between;gap:30px;margin:34px 0 36px}.lab-head h1{margin:14px 0;font-size:clamp(42px,5vw,54px);letter-spacing:-.04em}.lab-head p:last-child{max-width:760px;margin:0;color:var(--color-text-secondary);font-size:15px;line-height:1.75}.status{color:var(--color-text-secondary);font-size:10px}.status.connected{color:var(--color-accent-primary)}.lab-layout{display:grid;grid-template-columns:minmax(0,1fr) 320px;gap:20px}.console-surface{padding:26px}.surface-head{position:relative;z-index:1;display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.surface-head h2{margin:8px 0 0;font-size:26px}.surface-head>span{color:var(--color-text-secondary);font-size:10px}.field{position:relative;z-index:1;display:grid;gap:9px;margin-top:24px;color:var(--color-text-primary);font-size:12px}.field input,.field textarea{width:100%;padding:12px 14px;border:1px solid var(--color-border-default);border-radius:12px;outline:none;color:var(--color-text-primary);background:var(--color-bg-control);font:12px/1.7 "IBM Plex Mono",monospace;resize:vertical}.field input:focus,.field textarea:focus{border-color:var(--color-border-strong);box-shadow:var(--ui-focus-ring)}.connection-actions{position:relative;z-index:1;display:flex;gap:10px;margin-top:12px}.connection-actions button,.send,.log-head button{min-height:42px;padding:0 15px;border:1px solid var(--color-border-default);border-radius:10px;color:var(--color-text-primary);background:var(--color-bg-control);cursor:pointer}.connection-actions .primary,.send.primary{color:var(--color-accent-contrast);border-color:var(--color-action-primary);background:var(--color-action-primary);font-weight:600}.connection-actions button:disabled,.send:disabled{opacity:.45;cursor:not-allowed}.send{position:relative;z-index:1;margin-top:12px}.log-section{position:relative;z-index:1;margin-top:30px;padding-top:28px;border-top:1px solid color-mix(in srgb,var(--color-border-default) 58%,transparent)}.log-head{display:flex;align-items:flex-end;justify-content:space-between;gap:18px}.log-head h3{margin:8px 0 0;font-size:20px}.log-head>div:last-child{display:flex;gap:6px}.log-head button{min-height:34px;padding:0 10px;font-size:11px}.log-console{height:440px;margin-top:16px;padding:14px;overflow:auto;border:1px solid var(--color-border-strong);border-radius:14px;background:var(--color-bg-raised);font-size:10px}.log-empty{display:grid;height:100%;place-items:center;color:var(--color-text-secondary);text-align:center}.log-line{display:grid;grid-template-columns:72px 58px minmax(0,1fr);gap:10px;padding:10px 8px;border-bottom:1px solid rgba(255,255,255,.04);color:var(--color-text-secondary)}.log-line b{font-weight:400}.log-line code{white-space:pre-wrap;word-break:break-word}.log-line--send b{color:var(--color-accent-primary)}.log-line--receive b{color:var(--color-accent-secondary)}.log-line--error{color:#ffc7bd}.side-stack{display:grid;align-content:start;gap:20px}.side-card{padding:22px}.side-card>*{position:relative;z-index:1}.session-status{display:grid;gap:8px;margin-top:16px}.session-status strong{font-size:22px}.session-status span{color:var(--color-text-secondary);font-size:10px}.stat-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-top:20px}.stat-grid div{padding:12px;border:1px solid var(--color-border-default);border-radius:11px;background:var(--color-bg-raised)}.stat-grid small{display:block;color:var(--color-text-secondary);font-size:10px}.stat-grid strong{display:block;margin-top:6px;font-size:20px}.toggle{position:relative;display:grid;grid-template-columns:1fr auto;align-items:center;min-height:50px;margin-top:10px;padding:0 12px;border:1px solid var(--color-border-default);border-radius:11px;color:var(--color-text-secondary);background:var(--color-bg-control);cursor:pointer}.toggle input{position:absolute;opacity:0}.toggle:has(input:checked){border-color:var(--color-border-strong);color:var(--color-text-primary);background:var(--color-bg-selected);box-shadow:var(--shadow-selected)}.toggle b{color:var(--color-action-primary)}.side-card h3{margin:12px 0;font-size:20px}.side-card p:last-child{color:var(--color-text-secondary);font-size:13px;line-height:1.7}
